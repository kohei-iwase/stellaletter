class LikeAndDislike < ApplicationRecord
	...
	#ユーザーの性癖
  	...
  	#ユーザーの地雷
  	has_many :dislikes,class_name:  "UserStatus", foreign_key: "dislike_id", dependent: :destroy

  	#キャラクターの西壁
  	has_many :likes,class_name:  "CharacterStatus", foreign_key: "like_id", dependent: :destroy
  	#キャラクターの地雷
  	has_many :dislikes,class_name:  "CharacterStatus", foreign_key: "dislike_id", dependent: :destroy
